...
export abstract class View {
    ...
    private static initDynamicObjects() {
        this.MTextures = {
            PlayerSword: {
                pic: this.pics.sword_small_up,
                pos: {x: 610, y: 485},
                condition: () => GameState.player.isAttacking,
                mod: {targetRotation: 100, rotation: 0, opacity: 0.001}
            },
            PlayerShield: {pic: this.pics.shield_small, pos: {x: 620, y: 490}, condition: () => GameState.player.isDefending, mod: {opacity: 0.001}},
            OpponentSword: {
                pic: this.pics.sword_small_up,
                pos: {x: 610, y: 215},
                condition: () => GameState.opponent.isAttacking,
                mod: {rotation: 180, targetRotation: 270, opacity: 0.001}
            },
        ...
        switch (newState) {
            case menuState.MainMenu:
                ...
                Input.clickEvents = [
                    {
                        s: {x: 380, y: 200},
                        e: {x: 380 + 517, y: 200 + 82},
                        callback: () => {
                            this.changeState(menuState.PlayerSelect)
                            GameState.matchtype = gameType.SinglePlayer
                        }
                    },
                    {
                        s: {x: 380, y: 320},
                        e: {x: 380 + 517, y: 320 + 82},
                        callback: () => {
                            this.changeState(menuState.MPLobby)
                            GameState.matchtype = gameType.MultiPlyaer
                        }
                    },
                    {
                        s: {x: 380, y: 440},
                ...
                Input.clickEvents = [
                    {
                        ...
                        e: {x: 340, y: 245},
                        callback: () => {
                            Game.startMatch(Heroes.list.FROG)
                        }
                    },
                    {
                        s: {x: 540, y: 25},
                        e: {x: 740, y: 245},
                        callback: () => {
                            Game.startMatch(Heroes.list.DOG)
                        }
                    },
                    {
                        s: {x: 940, y: 25},
                        e: {x: 1140, y: 245},
                        callback: () => {
                            Game.startMatch(Heroes.list.CAT)
                        }
                    },
                    {
                        s: {x: 140, y: 540},
                        e: {x: 340, y: 690},
                        callback: () => {
                            Game.startMatch(Heroes.list.CHICK)
                        }
                    },
                    {
                        s: {x: 540, y: 540},
                        e: {x: 740, y: 690},
                        callback: () => {
                            Game.startMatch(Heroes.list.FISH)
                        }
                    },
                    {
                        s: {x: 940, y: 540},
                        e: {x: 1140, y: 690},
                        callback: () => {
                            Game.startMatch(Heroes.list.MONKEY)
                        }
                    }
                ]
                break
            ...
            case menuState.MPGame:
                ...
                Renderer.texts = [
                    ...
                    {text: '', pos: {x: 350, y: 587}, size: 14, color: '#2196F3', ctext: () => GameState.player.atkBuffCost + 'M'},
                    {text: 'DEF +10%', pos: {x: 275, y: 684}, size: 22, color: '#fff'},
                    {text: '', pos: {x: 350, y: 681}, size: 14, color: '#2196F3', ctext: () => GameState.player.defBuffCost + 'M'},
                    {text: 'ATK +5%\nDEF +5%', pos: {x: 442, y: 580}, size: 22, color: '#fff', multiline: true},
                    {text: '', pos: {x: 520, y: 587}, size: 14, color: '#2196F3', ctext: () => GameState.player.atkdefBuffCost + 'M'},
                    ...
                    {
                        text: '',
                        ctext: () => (GameState.matchtype == gameType.MultiPlyaer ? Multiplayer.room.opponentName : ''),
                        pos: {x: 640, y: 52},
                        size: 12,
                        color: '#5f220a'
                    },
                ...
                Input.clickEvents = [
                    ...
                    },
                    {
                        ...
                        e: {x: 540, y: 615},
                        callback: () => {
                            Game.atkdefBuff(GameState.player)
                        }
                    },
                    {
                        s: {x: 390, y: 640},
